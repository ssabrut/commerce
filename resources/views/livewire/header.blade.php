  ...
  <header class="bg-white h-20 shadow z-10 grid place-items-center">
    <div class="container 2xl:mx-auto">
      <div class="flex items-center">
        ...
        {{-- searcn bar --}}
        <div class="w-full border border-gray-300 rounded-md pl-4 mr-8 relative" x-data="{ show: false }" @click="show = true" @click.outside="show = false">
          ...
          <!-- product dropdown -->
          <div
            class="hidden absolute left-0 w-full rounded-b-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10 product-dropdown"
            role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1" x-show="show">
        ...
        @auth
          ...
          <!-- user icon -->
          <div class="grid place-items-center relative" x-data="{ show: @entangle('showDropdown') }">
            ...
            <!-- user dropdown -->
            <div
              class="absolute top-14 right-0 w-56 rounded-b-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10"
              role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1"
              x-data="{ show: @entangle('showDropdown') }" x-show="show">
              <div class="py-1" role="none">
                <!-- Active: "bg-gray-100 text-gray-900", Not Active: "text-gray-700" -->
                <a href="#" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
                  id="menu-item-0">Account
                  settings</a>
